...
- [x] Настройка UI Kit (Tamagui или NativeWind/Gluestack)
...
- [x] Индикаторы статуса синхронизации (UI)
- [ ] Механизм разрешения конфликтов

### 4. Основной функционал (Клиент)
- [x] Экран "Главная" (Дневник питания)
    - [x] Список приемов пищи и итоги дня
    - [x] CRUD операций (Добавление/Удаление)
    - [x] Отображение целей тренера
- [x] Экран "Анкета" (Ежедневная)
    - [x] Форма опроса (Сон, Стресс, Вес и др.)
    - [x] История анкет
- [x] Экран "Замеры" (Еженедельные)
    - [x] Форма ввода параметров тела
    - [x] Загрузка фото (Камера/Галерея)
    - [x] Графики прогресса

### 5. Профиль
- [x] Редактирование личных данных
- [x] Смена тренера (Ввод нового инвайта)
- [x] Смена пароля 
- [x] Выход из системы

---

## Фаза 3: Функционал Тренера (Мобильное приложение)

### 1. Навигация и Экраны
- [ ] Настройка навигации для роли "Тренер" (Bottom Tabs)
- [ ] Экран "Дашборд" (Список клиентов со статусами)

### 2. Управление клиентами
- [ ] Генерация и управление инвайт-кодами
- [ ] Карточка клиента:
    - [ ] Установка целей по питанию (БЖУК)
    - [ ] Просмотр дневника питания и графиков
    - [ ] Просмотр анкет и замеров (с фото)

---

## Фаза 4: Расширенный Бэкенд и Интеграции
...
- [ ] Замеры (CRUD, История)
- [ ] Профиль и Настройки
- [ ] API Тренера (Аналитика, Управление целями)
