...
Скрипт посева (`packages/api/prisma/seed.ts`) создает следующих пользователей для тестирования. 
...
| **Client** | `client@fitmetrics.com` | `client123` | Клиент, уже привязанный к тренеру выше |
